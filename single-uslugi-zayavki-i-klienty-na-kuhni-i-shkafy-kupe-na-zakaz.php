...
/**
 * Template Name: Заявки и клиенты на кухни и шкафы купе на заказ
...
<head>
	...
	<meta property="og:title" content="Заявки и клиенты на кухни и шкафы купе на заказ" />
	<meta property="og:description" content="Заявки и клиенты на кухни и шкафы купе на заказ" />
	<!-- Bootstrap CSS -->
	...
	<title>Заявки и клиенты на кухни и шкафы купе на заказ</title>
					...
					<div class="adapt-menu d-flex pb-3 px-3 px-sm-5 pb-lg-0 px-lg-0 justify-content-lg-end">
						<div class="navbar-nav">
							<ul class="header-menu nav justify-content-center">
								<li class="nav-item">
									<a class="nav-link" aria-current="page" href="<?php echo site_url('/'); ?>" data-target="main-page">Главная</a>
								</li>
	...
	<section id="main-home-header" class="home-header">
		<div class="container">
			<div class="row align-items-center">
				<div class="col">
					<h2 class="page-subtitle mb-3 mb-lg-0">Комплексное продвижение мебельных компаний</h2>
					<h1 class="home-title mb-3 mb-lg-1">Заявки и&nbsp;клиенты на&nbsp;кухни и&nbsp;шкафы купе на&nbsp;заказ</h1>
				...
				<div class="col text-start section-title text-md-center">
					...
					<div class="row">
						...
						<div class="col-lg-6 text-start pt-5 py-lg-0 ps-xl-5">
							<p>Приветствую, меня зовут Роман. С 2016 года я занимаюсь разработкой сайтов.</p>
							<p>Примерно через год работы я понимаю, что моим клиентам нужен не сайт, а нужны заявки и клиенты, и начинаю заниматься настройкой и ведением контекстной рекламы и SEO-продвижением.</p>
							<p>Еще через несколько лет я понимаю, что нельзя быть хорошим специалистом сразу во всех сферах бизнеса и я ограничил количество ниш, которыми я занимаюсь, до нескольких, наиболее мне интересных и понятных.</p>
							<p>Примерно с 2022 года большинство моих клиентов это компании в сфере производства и продажи корпусной мебели и эта ниша становится для меня основной.</p>
							<p class="mb-5">Если Вы занимаетесь мебельным бизнесом и Вам недостаточно заказчиков, обращайтесь, я постараюсь Вам помочь.</p>
							<button type="button" class="btn btn-lg btn-corporate-color-1 px-4" data-bs-toggle="modal" data-bs-target="#callbackModal">Оставить заявку</button>
						</div>
					</div>
				</div>
