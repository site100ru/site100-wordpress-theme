...
<body class="jobs-page"> <!-- data-spy="scroll" data-target="nav" style="position: relative;" add in body -->
    ...
    <nav id="top-menu-4" class="navbar navbar-expand-lg navbar-light bg-light d-none d-lg-block py-0 header header-light pb-2">
        <div class="container">
                    ...
                    <div class="d-flex list-inline align-items-center ms-lg-auto justify-content-end header-light">
                        ...
                        <div class="d-none d-lg-flex ms-3 justify-content-end">
                            <a class="nav-link ico-button me-3" href="https://t.me/79307878068" target="_blank">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/ico/telegram-ico.svg" alt="Telegram">
                            </a>
                            <a class="nav-link ico-button" href="https://wa.me/79307878068?web=1&app_absent=1" target="_blank">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/ico/whatsapp-ico.svg" alt="WhatsApp">
                            </a>
                        </div>
                    </div>
                </div>
